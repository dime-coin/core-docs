...
The [`getaddressbalance` RPC](../api/rpc-address-index.md#getaddressbalance) returns the balance for address(es).
...
The [`getaddressdeltas` RPC](../api/rpc-address-index.md#getaddressdeltas) returns all changes for an address.
...
The [`getaddressmempool` RPC](../api/rpc-address-index.md#getaddressmempool) returns all mempool deltas for an address.
...
The [`getaddresstxids` RPC](../api/rpc-address-index.md#getaddresstxids) returns the txids for an address(es).
...
The [`getaddressutxos` RPC](../api/rpc-address-index.md#getaddressutxos) returns all unspent outputs for an address.
